...
class SaasTemplate(models.Model):
    ...
    expiry_notify_days = fields.Integer(string="Expiry Days", default=3)


class SaasDB(models.Model):
    _inherit = "saas.db"

    expiry_notify_days = fields.Integer(string="Expiry Days")
...
class ProductProduct(models.Model):
    ...
    expiry_notify_days = fields.Integer(string="Expiry Days", store=True, related='saas_package_id.expiry_notify_days')


class ContractContract(models.Model):
    _inherit = "contract.contract"

    expiry_notify_days = fields.Integer(related="build_id.expiry_notify_days")
