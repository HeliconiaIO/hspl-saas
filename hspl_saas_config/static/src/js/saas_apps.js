odoo.define("hspl_saas_config.saas_apps", function (require) {
  "use strict";
  ...
  function renderTotalPrice() {
    ...
    var sum_user_prices = 0;
    if($("#users_block").length){
        sum_user_prices = user_qty * parseFloat($("#users_block").data("price-" + period));
    }
  ...
  $("#buy-now").on("click", function () {
    ...
    if ($("#users").length){
        var user_cnt = parseInt($("#users").val(), 10);
    } else {
        var user_cnt = 0;
    }
